<template>
    <div class="view-layout ticket-release-review">
        <div class="view-auto">
            <i-tools-m
				...
				<template slot="content">
                    <div class="tools-slot-btns">
                        <el-button size="mini" icon="el-icon-tickets" @click="$router.push('/ticket-release-child')">子工单</el-button>
                    </div>
                </template>
            </i-tools-m>
    ...
    methods: {
        listPage () {
            ...
            workOrderBaseListPage({
                ...
                createIds: JSON.stringify([JSON.parse(localStorage.getItem('userInfo')).id]) // 创建人
            }).then(res => {
