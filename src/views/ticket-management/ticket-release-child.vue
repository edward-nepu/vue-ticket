<template>
    <div class="view-layout ticket-release-child">
        <div class="view-auto">
            <i-tools-m
                whichShow="012367"
...
<script>
import { workOrderBaseSonListPage, workOrderBaseSonDelete } from '_api'
export default {
    name: 'ticket-release-child',
    data () {
        return {
            pageCurrent: 1,
            pageSize: 10,
