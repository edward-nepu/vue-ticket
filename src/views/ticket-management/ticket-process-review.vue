<template>
    <div class="view-layout ticket-process-review">
        <div class="view-auto">
            <i-tools-m
				...
				<template slot="content">
                    <div class="tools-slot-btns">
                        <el-button size="mini" icon="el-icon-tickets" @click="$router.push('/ticket-process-child')">子工单</el-button>
                    </div>
                </template>
            </i-tools-m>
